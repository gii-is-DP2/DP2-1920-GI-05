...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers("/owner/new").permitAll()
				...
				.antMatchers("/judges/**").hasAnyAuthority("judge","admin")	
				...
				.antMatchers("/guide/new").permitAll()
				.antMatchers("/guides/details").hasAnyAuthority("guide")	
				.antMatchers("/guides/{guideId}/**").hasAnyAuthority("guide")	
