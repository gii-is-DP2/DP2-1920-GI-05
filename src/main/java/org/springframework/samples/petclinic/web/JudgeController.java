...
public class JudgeController {
	...
	private static final String VIEWS_JUDGE_CREATE_OR_UPDATE_FORM = "owners/createOrUpdateJudgeForm";
	
	private final JudgeService judgeService;

	@Autowired
	public JudgeController(JudgeService clinicService, UserService userService, AuthoritiesService authoritiesService) {
		this.judgeService = clinicService;
	}
	...
	public String processUpdateGuideForm(@Valid Judge judge, BindingResult result,
		...
		if (result.hasErrors()) {
			...
			judge.setId(judgeId);
			this.judgeService.saveJudge(judge);
			return "redirect:/judges/{judgeId}";
		}
	}
